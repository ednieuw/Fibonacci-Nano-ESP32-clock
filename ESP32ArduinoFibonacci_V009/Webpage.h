...
<body style="color: #FFFFFF; background-color: #000000; font-family: Verdana, Geneva, Tahoma, sans-serif;">
  <table class="borders-table">
    <tr><td colspan="4"  class="center">
      <span class="darkorange"><h2>Fibonacci clock</h2></span>
    </td></tr>
    <tr>
      <td style="width: 60px"><a href="https://github.com/ednieuw/Fibonacci-Nano-ESP32-clock">Home</a></td>
      <td style="width: 100px"> <a href="https://www.ednieuw.nl">ednieuw.nl</a></td>
