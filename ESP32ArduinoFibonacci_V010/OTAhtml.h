...
<h2 style="color: #FFBB00;"> Upload Firmware (.bin)</h2>
...
Wait 20 seconds after upload <br>
and the clock menu will appear.</h3>
    ...
    <script>
      ...
      form.addEventListener('submit', function(e){
        ...
        xhr.onload = function() {
          if (xhr.status === 200) {
            bar.innerHTML = "✅ Update successful. Restarting... in 20 seconds";
